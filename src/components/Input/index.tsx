...
export const Input: React.FC<FormInputProps> = ({
    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <div className={`flex rounded bg-white dark:bg-[#17191C] ${error && "border border-red"}`}>
                <input
                    id={id}
                    name={name}
                    type={type}
                    ...
                    onBlur={onBlur}
                    required={required}
                    className={`rounded py-3 px-4 w-full appearance-none outline-none dark:placeholder:text-grey100 bg-transparent`}
                />
                {info &&
