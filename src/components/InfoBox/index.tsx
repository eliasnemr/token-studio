const InfoBox: React.FC<React.PropsWithChildren> = ({ children }) => (
  <div className="mx-auto bg-lighterYellow bg-opacity-10 dark:bg-darkContrast border-l-4 border-yellow px-5 py-3 rounded-[4px]">
    <div className="flex items-center justify-center">
      <span className="pr-5 hidden lg:block">
        <svg
          ...
          className="text-black dark:text-yellow"
        >
          <path
      ...
      <p className="text-xs lg:text-sm text-black dark:text-yellow">
        {children}
      </p>
    </div>
  </div>
